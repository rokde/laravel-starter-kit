...
class WorkspaceTransferredNotification extends Notification implements InAppNotification
{
    ...
    {
        return 'Get notified when you have successfully transferred a workspace.';
    }
    ...
    {
        return __('You have successfully transferred workspace :workspace to :member.', [
            'workspace' => $this->workspace->name,
            'member' => $this->workspace->owner->name,
        ]);
    }
}
