...
class ApplicationHeaderLayout extends Variant
{
    public function __construct()
    {
        ...
        $this->variant->add(new LayoutFile(
            ...
            pattern: "~import AppLayout from '@\/layouts\/app\/AppSidebarLayout\.vue';~",
            replacement: "import AppLayout from '@/layouts/app/AppHeaderLayout.vue';",
        ))
            ->add(new LayoutFile(
