...
class User extends Authenticatable implements HasLocalePreference, MustVerifyEmail, HasPasskeys
{
    use HasFactory, ManagesWorkspaces, Notifiable, InteractsWithPasskeys;
