...
const translations: Translations = {
    "en": {
        ...
        "If you remove the passkey, you can not login again with the passkey.": "If you remove the passkey, you can not login again with the passkey.",
    ...
    "de": {
        ...
        "Get notified when a member accepts the invitation to any of your workspaces.": "Lassen Sie sich benachrichtigen, wenn ein Mitglied die Einladung zu einem Ihrer Workspaces annimmt.",
        "Get notified when you got an invitation to another workspace.": "Lassen Sie sich benachrichtigen, wenn Sie eine Einladung zu einem anderen Workspace erhalten haben.",
        "If you remove the member, they will no longer have access to the workspace.": "Wenn Sie das Mitglied entfernen, hat es keinen Zugriff mehr auf den Workspace.",
        "If you revoke the invitation, the user will not be able to access the workspace.": "Wenn Sie die Einladung widerrufen, kann der Benutzer nicht mehr auf den Workspace zugreifen.",
        ...
        "Work together with other users by inviting them to your workspace. Invitations can be sent to email addresses. Invitations can be revoked at any time.": "Arbeiten Sie mit anderen Benutzern zusammen, indem Sie sie zu Ihrem Workspace einladen. Einladungen können an E-Mail-Adressen gesendet und  jederzeit widerrufen werden.",
        ...
        "No sort order": "Keine Sortierung",
        "Sort in ascending order": "Aufsteigend sortieren",
        "Sort in descending order": "Absteigend sortieren",
        "Do you really want to remove the property? All property values will be removed on all items. This action can not be undone.": "Möchten Sie das Attribut wirklich entfernen? Alle Attributwerte werden für alle Ressourcen entfernt. Diese Aktion kann nicht rückgängig gemacht werden.",
        "Hex Color": "Hexadezimaler Farbcode",
        "Label": "Bezeichnung",
        "Manage your custom properties to extend your resources to your needs.": "Verwalten Sie Ihre benutzerdefinierten Attribute, um Ihre Ressourcen an Ihre Bedürfnisse anzupassen.",
        "Decimal places": "Nachkommastellen",
        "Suffix": "Suffix",
        "Number": "Zahl",
        "Numeric": "Numerisch",
        "Required": "Erforderlich",
        "Rules provide form input validation to ensure that the value entered is valid. For example, you can require a value to be numeric or a string with a maximum length of 255 characters.": "Regeln ermöglichen die Überprüfung von Formulareingaben, um sicherzustellen, dass der eingegebene Wert gültig ist. Sie können zum Beispiel verlangen, dass ein Wert numerisch oder eine Zeichenkette mit einer maximalen Länge von 255 Zeichen sein muss.",
        "Rules": "Regeln",
        "Select": "Auswahl",
        "String": "Zeichenfolge",
        "Text": "Text",
        "The type of the field configures the possible input element and a base validation of the provided value.": "Der Typ eines Attributes konfiguriert das mögliche Eingabeelement und eine Basisvalidierung des eingegebenen Wertes.",
        "The default value is used for all items that do not have a value set. It will be the pre-set value on creating new items.": "Der Standardwert wird für alle Ressourcen verwendet, für die kein Wert festgelegt wurde. Er ist der voreingestellte Wert bei der Erstellung neuer Ressourcen.",
        "The label is used to identify the field in the UI.": "Die Bezeichnung wird zur Identifizierung des Attributes in der Benutzeroberfläche verwendet.",
        "Type": "Typ",
        ...
        "If you remove the passkey, you can not login again with the passkey.": "Wenn Sie den Passkey entfernen, können Sie sich nicht mehr mit dem Passkey anmelden.",
        "Update your account's passkeys to use a more secure way to login": "Aktualisieren Sie die Passkeys Ihres Kontos, um eine sicherere Art der Anmeldung zu verwenden",
        ...
        "Todo settings": "Einstellungen für Aufgaben",
