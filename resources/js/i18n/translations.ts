...
const translations: Translations = {
    en: {
        ...
        agreement_end: '.',
        agreement_start: 'By creating an account you agree to our',
        'log in': 'log in',
        status: 'status',
        locales: {
            de: 'Deutsch',
    ...
    de: {
        ...
        agreement_end: 'einverstanden.',
        agreement_start: 'Durch die Erstellung eines Kontos erklären Sie sich mit unseren',
        and: 'und',
        'log in': 'anmelden',
        now: 'Gerade eben',
        status: 'Status',
